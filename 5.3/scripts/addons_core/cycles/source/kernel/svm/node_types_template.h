...
/* Occupies the former NODE_PAD1 slot so KernelData / NODE_NUM stay ABI-stable. */
SHADER_NODE_TYPE(NODE_PARALLAX_OCCLUSION)
SHADER_NODE_TYPE(NODE_BILLBOARD_DISPLACEMENT)
