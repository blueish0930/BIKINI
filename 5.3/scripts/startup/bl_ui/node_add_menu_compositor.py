...
class NODE_MT_compositor_node_filter_base(node_add_menu.NodeMenu):
    ...
    def draw(self, context):
        ...
        self.node_operator(layout, "CompositorNodeNeural", label="DLSS Neural")
        self.node_operator_search_alias(context, layout, "CompositorNodeNeural", "DLSS 5")
        self.node_operator_search_alias(context, layout, "CompositorNodeNeural", "Neural Rendering")
