...
class NODE_MT_gn_input_scene_base(node_add_menu.NodeMenu):
    ...
    def draw(self, context):
        ...
        if context.space_data.node_tree_sub_type == 'TOOL':
            self.node_operator(layout, "GeometryNodeModalEvent")
...
class NODE_MT_gn_simulation_box_engine_base(node_add_menu.NodeMenu):
    ...
    def draw(self, context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeBoxEngineSetRigidBody", label="Box Set Rigid Body")
        self.node_operator(layout, "GeometryNodeBoxEngineSetConstraint", label="Box Set Constraint")
        layout.separator()
        self.node_operator(layout, "GeometryNodeBoxEngineSolver", label="Box Solver")
...
# ---------------------------------------------------------------------------
# Bikini: user-added nodes. Official GN outline first, then Lib (CGAL / solvers).
# ---------------------------------------------------------------------------

class NODE_MT_gn_bikini_input_base(node_add_menu.NodeMenu):
    bl_label = "Input"
    menu_path = "Bikini/Input"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "NodeEnableInput")
        self.node_operator(layout, "GeometryNodeSetGroupInputDefault")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_output_base(node_add_menu.NodeMenu):
    bl_label = "Output"
    menu_path = "Bikini/Output"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeGuideGeometry")
        self.node_operator(layout, "GeometryNodeDebug")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_geometry_read_base(node_add_menu.NodeMenu):
    bl_label = "Read"
    menu_path = "Bikini/Geometry/Read"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeNamedPortal")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_geometry_write_base(node_add_menu.NodeMenu):
    bl_label = "Write"
    menu_path = "Bikini/Geometry/Write"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeStoreNamedPortal")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_geometry_sample_base(node_add_menu.NodeMenu):
    bl_label = "Sample"
    menu_path = "Bikini/Geometry/Sample"
...
class NODE_MT_gn_bikini_geometry_operations_base(node_add_menu.NodeMenu):
    bl_label = "Operations"
    menu_path = "Bikini/Geometry/Operations"
...
class NODE_MT_gn_bikini_geometry_base(node_add_menu.NodeMenu):
    bl_label = "Geometry"
    menu_path = "Bikini/Geometry"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Geometry/Read")
        self.draw_menu(layout, path="Bikini/Geometry/Sample")
        self.draw_menu(layout, path="Bikini/Geometry/Write")
        layout.separator()
        self.draw_menu(layout, path="Bikini/Geometry/Operations")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_curve_operations_base(node_add_menu.NodeMenu):
    bl_label = "Operations"
    menu_path = "Bikini/Curve/Operations"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCurveIntersections")
        self.node_operator(layout, "GeometryNodeCgalSimplifyPolyline3")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_curve_base(node_add_menu.NodeMenu):
    bl_label = "Curve"
    menu_path = "Bikini/Curve"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Curve/Operations")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_mesh_operations_base(node_add_menu.NodeMenu):
    bl_label = "Operations"
    menu_path = "Bikini/Mesh/Operations"
...
class NODE_MT_gn_bikini_mesh_base(node_add_menu.NodeMenu):
    bl_label = "Mesh"
    menu_path = "Bikini/Mesh"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Mesh/Operations")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_simulation_base(node_add_menu.NodeMenu):
    bl_label = "Simulation"
    menu_path = "Bikini/Simulation"
...
class NODE_MT_gn_bikini_utilities_field_base(node_add_menu.NodeMenu):
    bl_label = "Field"
    menu_path = "Bikini/Utilities/Field"
...
class NODE_MT_gn_bikini_utilities_vector_base(node_add_menu.NodeMenu):
    bl_label = "Vector"
    menu_path = "Bikini/Utilities/Vector"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "FunctionNodeGetVectorComponent")
        self.node_operator(layout, "FunctionNodeSetVectorComponent")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_utilities_matrix_base(node_add_menu.NodeMenu):
    bl_label = "Matrix"
    menu_path = "Bikini/Utilities/Matrix"
...
class NODE_MT_gn_bikini_utilities_closure_base(node_add_menu.NodeMenu):
    bl_label = "Closure"
    menu_path = "Bikini/Utilities/Closure"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeSetClosureDefault")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_utilities_text_base(node_add_menu.NodeMenu):
    bl_label = "Text"
    menu_path = "Bikini/Utilities/Text"
...
class NODE_MT_gn_bikini_utilities_base(node_add_menu.NodeMenu):
    bl_label = "Utilities"
    menu_path = "Bikini/Utilities"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Utilities/Field")
        self.draw_menu(layout, path="Bikini/Utilities/Vector")
        self.draw_menu(layout, path="Bikini/Utilities/Matrix")
        self.draw_menu(layout, path="Bikini/Utilities/Closure")
        self.draw_menu(layout, path="Bikini/Utilities/Text")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_mesh_processing_base(node_add_menu.NodeMenu):
    bl_label = "Processing"
    menu_path = "Bikini/Lib/CGAL/Mesh/Processing"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalConstrainedSimplify")
        self.node_operator(layout, "GeometryNodeCgalCollapseShortEdges")
        self.node_operator(layout, "GeometryNodeCgalVsaApproximate")
        self.node_operator(layout, "GeometryNodeCgalSmoothShape")
        self.node_operator(layout, "GeometryNodeCgalFair")
        self.node_operator(layout, "GeometryNodeCgalFairHoleFill")
        self.node_operator(layout, "GeometryNodeCgalRepair")
        self.node_operator(layout, "GeometryNodeCgalOrientOutward")
        self.node_operator(layout, "GeometryNodeCgalRepairSelfIntersect")
        self.node_operator(layout, "GeometryNodeCgalSplitLongEdges")
        self.node_operator(layout, "GeometryNodeCgalAutorefine")
        self.node_operator(layout, "GeometryNodeCgalSnapBorders")
        self.node_operator(layout, "GeometryNodeCgalRemoveDegenerate")
        self.node_operator(layout, "GeometryNodeCgalRepairDegeneracies")
        ...
        self.node_operator(layout, "GeometryNodeCgalExteriorSkeleton2")
        self.node_operator(layout, "GeometryNodeCgalPolygonOffset2")
        self.node_operator(layout, "GeometryNodeCgalPolygonFill2")
        self.node_operator(layout, "GeometryNodeCgalPolygonRepair2")
        self.node_operator(layout, "GeometryNodeCgalRegularizeOpenContour2")
        self.node_operator(layout, "GeometryNodeCgalExtrudeSkeleton")
        self.node_operator(layout, "GeometryNodeCgalConvexPartition2")
        self.node_operator(layout, "GeometryNodeCgalSsabPartition2")
        self.node_operator(layout, "GeometryNodeCgalYMonotonePartition2")
        self.node_operator(layout, "GeometryNodeCgalPolylineSimplify2")
        self.node_operator(layout, "GeometryNodeCgalRefineMesh2")
...
class NODE_MT_gn_lib_cgal_mesh_deform_base(node_add_menu.NodeMenu):
    bl_label = "Deform"
    menu_path = "Bikini/Lib/CGAL/Mesh/Deform"
...
class NODE_MT_gn_lib_cgal_mesh_boolean_base(node_add_menu.NodeMenu):
    bl_label = "Boolean"
    menu_path = "Bikini/Lib/CGAL/Mesh/Boolean"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalMeshBoolean")
        self.node_operator(layout, "GeometryNodeCgalCorefine")
        self.node_operator(layout, "GeometryNodeCgalMeshIntersection")
        self.node_operator(layout, "GeometryNodeCgalMinkowskiSum3")
        self.node_operator(layout, "GeometryNodeCgalDoIntersect3")
        layout.separator()
        self.node_operator(layout, "GeometryNodeCgalBooleanOps2")
        self.node_operator(layout, "GeometryNodeCgalDoIntersect2")
        self.node_operator(layout, "GeometryNodeCgalMinkowskiSum2")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_mesh_analyze_base(node_add_menu.NodeMenu):
    bl_label = "Analyze"
    menu_path = "Bikini/Lib/CGAL/Mesh/Analyze"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalDoesSelfIntersect")
        self.node_operator(layout, "GeometryNodeCgalMarkSelfIntersect")
        self.node_operator(layout, "GeometryNodeCgalIsClosed")
        ...
        self.node_operator(layout, "GeometryNodeCgalPrincipalCurvature")
        self.node_operator(layout, "GeometryNodeCgalShapeDiameter")
        self.node_operator(layout, "GeometryNodeCgalRegionGrowing")
        self.node_operator(layout, "GeometryNodeCgalSurfaceShortestPath")
        self.node_operator(layout, "GeometryNodeCgalExactGeodesic")
        self.node_operator(layout, "GeometryNodeCgalGeodesicVoronoi")
        self.node_operator(layout, "GeometryNodeCgalSkeletonSpokes")
        self.node_operator(layout, "GeometryNodeCgalSelfIntersectionCurves")
        self.node_operator(layout, "GeometryNodeCgalMeshSlicer")
        ...
        self.node_operator(layout, "GeometryNodeCgalMedialAxis2")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_mesh_uv_base(node_add_menu.NodeMenu):
    bl_label = "UV"
    menu_path = "Bikini/Lib/CGAL/Mesh/UV"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalLscmUV")
        self.node_operator(layout, "GeometryNodeCgalArapUV")
        self.node_operator(layout, "GeometryNodeCgalUVDistortion")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_mesh_base(node_add_menu.NodeMenu):
    bl_label = "Mesh"
    menu_path = "Bikini/Lib/CGAL/Mesh"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh/Processing")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh/Deform")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh/Boolean")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh/Analyze")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh/UV")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_points_reconstruction_base(node_add_menu.NodeMenu):
    bl_label = "Reconstruction"
    menu_path = "Bikini/Lib/CGAL/Points/Reconstruction"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalAlphaShape")
        self.node_operator(layout, "GeometryNodeCgalAlphaWrap")
        self.node_operator(layout, "GeometryNodeCgalAdvancingFront")
        self.node_operator(layout, "GeometryNodeCgalPoisson")
        self.node_operator(layout, "GeometryNodeCgalScaleSpace")
        self.node_operator(layout, "GeometryNodeCgalSkinSurface")
...
class NODE_MT_gn_lib_cgal_points_processing_base(node_add_menu.NodeMenu):
    bl_label = "Processing"
    menu_path = "Bikini/Lib/CGAL/Points/Processing"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalEstimateNormals")
        self.node_operator(layout, "GeometryNodeCgalVcmEstimateNormals")
        self.node_operator(layout, "GeometryNodeCgalJetSmooth")
        self.node_operator(layout, "GeometryNodeCgalBilateralSmooth")
        self.node_operator(layout, "GeometryNodeCgalRemoveOutliers")
        self.node_operator(layout, "GeometryNodeCgalWLOP")
        self.node_operator(layout, "GeometryNodeCgalHierarchySimplify")
        self.node_operator(layout, "GeometryNodeCgalEdgeAwareUpsample")
        self.node_operator(layout, "GeometryNodeCgalPcaEstimateNormals")
        self.node_operator(layout, "GeometryNodeCgalMstOrientNormals")
        self.node_operator(layout, "GeometryNodeCgalClusterPointSet")
        self.node_operator(layout, "GeometryNodeCgalVcmFeatureEdges")
        self.node_operator(layout, "GeometryNodeCgalPointShapeFitting")
...
class NODE_MT_gn_lib_cgal_points_shape_base(node_add_menu.NodeMenu):
    bl_label = "Shape"
    menu_path = "Bikini/Lib/CGAL/Points/Shape"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeCgalDelaunay3D")
        self.node_operator(layout, "GeometryNodeCgalMinSphere")
        self.node_operator(layout, "GeometryNodeCgalMinCircle2")
        self.node_operator(layout, "GeometryNodeCgalMinRectangle2")
        self.node_operator(layout, "GeometryNodeCgalMinEllipse2")
        self.node_operator(layout, "GeometryNodeCgalMinParallelogram2")
        self.node_operator(layout, "GeometryNodeCgalMinAnnulus2")
        self.node_operator(layout, "GeometryNodeCgalMaxAreaKGon2")
        self.node_operator(layout, "GeometryNodeCgalMaxPerimeterKGon2")
        self.node_operator(layout, "GeometryNodeCgalWidth3")
        self.node_operator(layout, "GeometryNodeCgalDelaunay2")
        self.node_operator(layout, "GeometryNodeCgalAlphaShape2")
        self.node_operator(layout, "GeometryNodeCgalVoronoi2")
        self.node_operator(layout, "GeometryNodeCgalVoronoi3")
        self.node_operator(layout, "GeometryNodeCgalPeriodicDelaunay2")
        self.node_operator(layout, "GeometryNodeCgalPeriodicDelaunay3")
        self.node_operator(layout, "GeometryNodeCgalDelaunayOnSphere")
        self.node_operator(layout, "GeometryNodeCgalVoronoiOnSphere")
        self.node_operator(layout, "GeometryNodeCgalLargestEmptyCircle2")
        self.node_operator(layout, "GeometryNodeCgalLargestEmptySphere3")
        self.node_operator(layout, "GeometryNodeCgalMinWidth2")
        self.node_operator(layout, "GeometryNodeCgalMinSphereOfSpheres")
        self.node_operator(layout, "GeometryNodeCgalOptimalBBox")
        self.node_operator(layout, "GeometryNodeCgalMinEllipsoid")
        self.node_operator(layout, "GeometryNodeCgalLargestEmptyIsoRectangle2")
        self.node_operator(layout, "GeometryNodeCgalMongeJetFit")
        self.node_operator(layout, "GeometryNodeCgalEuclideanMst3")
        self.node_operator(layout, "GeometryNodeCgalConvexLayers2")
        self.node_operator(layout, "GeometryNodeCgalConvexLayers3")
        self.node_operator(layout, "GeometryNodeCgalPeriodicVoronoi2")
        self.node_operator(layout, "GeometryNodeCgalPeriodicVoronoi3")
        self.node_operator(layout, "GeometryNodeCgalMinCylinder3")
        self.node_operator(layout, "GeometryNodeCgalMinAnnulus3")
        self.node_operator(layout, "GeometryNodeCgalSimplePolygon2")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_points_base(node_add_menu.NodeMenu):
    bl_label = "Points"
    menu_path = "Bikini/Lib/CGAL/Points"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Points/Processing")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Points/Reconstruction")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Points/Shape")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_cgal_base(node_add_menu.NodeMenu):
    bl_label = "CGAL"
    menu_path = "Bikini/Lib/CGAL"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Mesh")
        self.draw_menu(layout, path="Bikini/Lib/CGAL/Points")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_box_solver_base(node_add_menu.NodeMenu):
    bl_label = "Box Solver"
    menu_path = "Bikini/Lib/Box Solver"
...
class NODE_MT_gn_lib_jolt_solver_base(node_add_menu.NodeMenu):
    bl_label = "Jolt Solver"
    menu_path = "Bikini/Lib/Jolt Solver"

    def draw(self, _context):
        layout = self.layout
        self.node_operator(layout, "GeometryNodeJoltSetRigidBody", label="Jolt Set Rigid Body")
        self.node_operator(layout, "GeometryNodeJoltSetConstraint", label="Jolt Set Constraint")
        layout.separator()
        self.node_operator(layout, "GeometryNodeJoltSolver", label="Jolt Solver")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_lib_physics_base(node_add_menu.NodeMenu):
    bl_label = "Physics"
    menu_path = "Bikini/Lib/Physics"
...
class NODE_MT_gn_lib_deformable_base(node_add_menu.NodeMenu):
    bl_label = "Deformable"
    menu_path = "Bikini/Lib/Deformable"
...
class NODE_MT_gn_lib_base(node_add_menu.NodeMenu):
    bl_label = "Lib"
    menu_path = "Bikini/Lib"

    def draw(self, _context):
        layout = self.layout
        self.draw_menu(layout, path="Bikini/Lib/CGAL")
        self.draw_menu(layout, path="Bikini/Lib/Box Solver")
        self.draw_menu(layout, path="Bikini/Lib/Jolt Solver")
        self.draw_assets_for_catalog(layout, self.menu_path)


class NODE_MT_gn_bikini_base(node_add_menu.NodeMenu):
    bl_label = "Bikini"
    menu_path = "Bikini"
    ...
    def draw(self, _context):
        ...
        layout.separator()
        self.draw_menu(layout, path="Bikini/Geometry")
        layout.separator()
        self.draw_menu(layout, path="Bikini/Curve")
        self.draw_menu(layout, path="Bikini/Mesh")
        layout.separator()
        self.draw_menu(layout, path="Bikini/Lib")
        layout.separator()
        self.draw_menu(layout, path="Bikini/Simulation")
        layout.separator()
        self.draw_menu(layout, path="Bikini/Utilities")
        self.draw_assets_for_catalog(layout, self.menu_path)
...
add_menus = {
    ...
    "NODE_MT_geometry_node_bikini": NODE_MT_gn_bikini_base,
    "NODE_MT_geometry_node_bikini_input": NODE_MT_gn_bikini_input_base,
    "NODE_MT_geometry_node_bikini_output": NODE_MT_gn_bikini_output_base,
    "NODE_MT_geometry_node_bikini_geometry": NODE_MT_gn_bikini_geometry_base,
    "NODE_MT_geometry_node_bikini_geometry_read": NODE_MT_gn_bikini_geometry_read_base,
    "NODE_MT_geometry_node_bikini_geometry_write": NODE_MT_gn_bikini_geometry_write_base,
    "NODE_MT_geometry_node_bikini_geometry_operations": NODE_MT_gn_bikini_geometry_operations_base,
    "NODE_MT_geometry_node_bikini_geometry_sample": NODE_MT_gn_bikini_geometry_sample_base,
    "NODE_MT_geometry_node_bikini_curve": NODE_MT_gn_bikini_curve_base,
    "NODE_MT_geometry_node_bikini_curve_operations": NODE_MT_gn_bikini_curve_operations_base,
    "NODE_MT_geometry_node_bikini_mesh": NODE_MT_gn_bikini_mesh_base,
    "NODE_MT_geometry_node_bikini_mesh_operations": NODE_MT_gn_bikini_mesh_operations_base,
    "NODE_MT_geometry_node_bikini_simulation": NODE_MT_gn_bikini_simulation_base,
    "NODE_MT_geometry_node_bikini_utilities": NODE_MT_gn_bikini_utilities_base,
    "NODE_MT_geometry_node_bikini_utilities_field": NODE_MT_gn_bikini_utilities_field_base,
    "NODE_MT_geometry_node_bikini_utilities_vector": NODE_MT_gn_bikini_utilities_vector_base,
    "NODE_MT_geometry_node_bikini_utilities_matrix": NODE_MT_gn_bikini_utilities_matrix_base,
    "NODE_MT_geometry_node_bikini_utilities_closure": NODE_MT_gn_bikini_utilities_closure_base,
    "NODE_MT_geometry_node_bikini_utilities_text": NODE_MT_gn_bikini_utilities_text_base,
    "NODE_MT_geometry_node_lib": NODE_MT_gn_lib_base,
    "NODE_MT_geometry_node_lib_cgal": NODE_MT_gn_lib_cgal_base,
    "NODE_MT_geometry_node_lib_cgal_mesh": NODE_MT_gn_lib_cgal_mesh_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_processing": NODE_MT_gn_lib_cgal_mesh_processing_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_deform": NODE_MT_gn_lib_cgal_mesh_deform_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_boolean": NODE_MT_gn_lib_cgal_mesh_boolean_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_analyze": NODE_MT_gn_lib_cgal_mesh_analyze_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_uv": NODE_MT_gn_lib_cgal_mesh_uv_base,
    "NODE_MT_geometry_node_lib_cgal_points": NODE_MT_gn_lib_cgal_points_base,
    "NODE_MT_geometry_node_lib_cgal_points_reconstruction": NODE_MT_gn_lib_cgal_points_reconstruction_base,
    "NODE_MT_geometry_node_lib_cgal_points_processing": NODE_MT_gn_lib_cgal_points_processing_base,
    "NODE_MT_geometry_node_lib_cgal_points_shape": NODE_MT_gn_lib_cgal_points_shape_base,
    "NODE_MT_geometry_node_lib_box_solver": NODE_MT_gn_lib_box_solver_base,
    "NODE_MT_geometry_node_lib_jolt_solver": NODE_MT_gn_lib_jolt_solver_base,
    "NODE_MT_geometry_node_lib_deformable": NODE_MT_gn_lib_deformable_base,
    "NODE_MT_geometry_node_lib_physics": NODE_MT_gn_lib_physics_base,
    "NODE_MT_category_simulation_box_engine": NODE_MT_gn_lib_box_solver_base,
...
swap_menus = {
    ...
    "NODE_MT_gn_simulation_box_engine_swap": NODE_MT_gn_lib_box_solver_base,
    "NODE_MT_geometry_node_bikini_swap": NODE_MT_gn_bikini_base,
    "NODE_MT_geometry_node_bikini_input_swap": NODE_MT_gn_bikini_input_base,
    "NODE_MT_geometry_node_bikini_output_swap": NODE_MT_gn_bikini_output_base,
    "NODE_MT_geometry_node_bikini_geometry_swap": NODE_MT_gn_bikini_geometry_base,
    "NODE_MT_geometry_node_bikini_geometry_read_swap": NODE_MT_gn_bikini_geometry_read_base,
    "NODE_MT_geometry_node_bikini_geometry_write_swap": NODE_MT_gn_bikini_geometry_write_base,
    "NODE_MT_geometry_node_bikini_geometry_operations_swap": NODE_MT_gn_bikini_geometry_operations_base,
    "NODE_MT_geometry_node_bikini_geometry_sample_swap": NODE_MT_gn_bikini_geometry_sample_base,
    "NODE_MT_geometry_node_bikini_curve_swap": NODE_MT_gn_bikini_curve_base,
    "NODE_MT_geometry_node_bikini_curve_operations_swap": NODE_MT_gn_bikini_curve_operations_base,
    "NODE_MT_geometry_node_bikini_mesh_swap": NODE_MT_gn_bikini_mesh_base,
    "NODE_MT_geometry_node_bikini_mesh_operations_swap": NODE_MT_gn_bikini_mesh_operations_base,
    "NODE_MT_geometry_node_bikini_simulation_swap": NODE_MT_gn_bikini_simulation_base,
    "NODE_MT_geometry_node_bikini_utilities_swap": NODE_MT_gn_bikini_utilities_base,
    "NODE_MT_geometry_node_bikini_utilities_field_swap": NODE_MT_gn_bikini_utilities_field_base,
    "NODE_MT_geometry_node_bikini_utilities_vector_swap": NODE_MT_gn_bikini_utilities_vector_base,
    "NODE_MT_geometry_node_bikini_utilities_matrix_swap": NODE_MT_gn_bikini_utilities_matrix_base,
    "NODE_MT_geometry_node_bikini_utilities_closure_swap": NODE_MT_gn_bikini_utilities_closure_base,
    "NODE_MT_geometry_node_bikini_utilities_text_swap": NODE_MT_gn_bikini_utilities_text_base,
    "NODE_MT_geometry_node_lib_swap": NODE_MT_gn_lib_base,
    "NODE_MT_geometry_node_lib_cgal_swap": NODE_MT_gn_lib_cgal_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_swap": NODE_MT_gn_lib_cgal_mesh_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_processing_swap": NODE_MT_gn_lib_cgal_mesh_processing_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_deform_swap": NODE_MT_gn_lib_cgal_mesh_deform_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_boolean_swap": NODE_MT_gn_lib_cgal_mesh_boolean_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_analyze_swap": NODE_MT_gn_lib_cgal_mesh_analyze_base,
    "NODE_MT_geometry_node_lib_cgal_mesh_uv_swap": NODE_MT_gn_lib_cgal_mesh_uv_base,
    "NODE_MT_geometry_node_lib_cgal_points_swap": NODE_MT_gn_lib_cgal_points_base,
    "NODE_MT_geometry_node_lib_cgal_points_reconstruction_swap": NODE_MT_gn_lib_cgal_points_reconstruction_base,
    "NODE_MT_geometry_node_lib_cgal_points_processing_swap": NODE_MT_gn_lib_cgal_points_processing_base,
    "NODE_MT_geometry_node_lib_cgal_points_shape_swap": NODE_MT_gn_lib_cgal_points_shape_base,
    "NODE_MT_geometry_node_lib_box_solver_swap": NODE_MT_gn_lib_box_solver_base,
    "NODE_MT_geometry_node_lib_jolt_solver_swap": NODE_MT_gn_lib_jolt_solver_base,
    "NODE_MT_geometry_node_lib_deformable_swap": NODE_MT_gn_lib_deformable_base,
    "NODE_MT_geometry_node_lib_physics_swap": NODE_MT_gn_lib_physics_base,
