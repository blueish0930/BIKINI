...
_km_hierarchy = [
    ...
    ('Data-Block Relations', 'DATABLOCK_GRAPH', 'WINDOW', [
        ('Data-Block Graph Generic', 'DATABLOCK_GRAPH', 'WINDOW', []),
        ('Data-Block Graph Tool: Tweak', 'DATABLOCK_GRAPH', 'WINDOW', []),
        ('Data-Block Graph Tool: Select Box', 'DATABLOCK_GRAPH', 'WINDOW', []),
        ('Data-Block Graph Tool: Select Circle', 'DATABLOCK_GRAPH', 'WINDOW', []),
        ('Data-Block Graph Tool: Select Lasso', 'DATABLOCK_GRAPH', 'WINDOW', []),
        _km_expand_from_toolsystem('DATABLOCK_GRAPH', None),
    ]),
